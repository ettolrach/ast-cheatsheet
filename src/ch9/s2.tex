\wde{n.n., Maximal} An element $m$ of an ordered set $X$ is \textit{maximal} if there is no element $x \in X$ such that $m < x$.
\wde{n.n., Greatest} A \textit{greatest} element of an ordered set $X$ is an element $g$ such that $x \leq g$ for all $x \in X$.
