\wde{n.n., Image} Let $f \colon X \to Y$ and $A \subseteq X$ with the inclusion $i$. The \textit{image of $A$ under $f$} is defined to be $f_*A = \bigcup_{a \in A} \{ fi(a) \} \subseteq Y$.
\wl{4.4.2} Let $f \colon X \to Y$ and $A \subseteq X$. Then for $y \in Y$, $y \in_Y f_*A \iff y = f(x)$ for some $x \in X$ such that $x \in_X A$.
...
\wde{n.n., Preimage} Let $f \colon X \to Y$ and a subset $B \subseteq Y$. The \textit{preimage of $B$ under $f$} is the subset $f^*B$ of $X$ whose characteristic function is the composite $X \xrightarrow{f} Y \xrightarrow{\chi_B} \mathbf{2}$.
