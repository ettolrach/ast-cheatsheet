...
\wl{3.3.3} Let $N$ and $N'$ be sets, let $z \in N$ and $z' \in N'$, andlet $\sigma \colon N \to N$ and $\sigma' \colon N' \to N'$. Suppose there exists an isomorphism $j \colon N \to N'$ such that the diagram [above right] commutes. Then $N$ together with $z$ and $\sigma$ is a natural number system iff $N'$ together with $z'$ and $\sigma'$ is.
...
\wde{n.n.} We write the natural number system as $\N$ together with $0 \in \N$ and $s \colon \N \to \N$. The function $s$ is called the \textit{successor} function.