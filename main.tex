...
\begin{document}
  \begin{multicols}{2}
    ...
    \input{src/ch4/s2_minimal.tex}
    %
    % 4.3 Operations on subsets
    %\input{src/ch4/s3.tex}
    \input{src/ch4/s3_minimal.tex}
    %
    ...
    \input{src/ch5/s1_minimal.tex}
    %
    % 5.2 Graphs
    %\input{src/ch5/s2.tex}
    \input{src/ch5/s2_minimal.tex}
    %
    % 5.3 Quantifiers
    ...
    \input{src/ch7/s3_minimal.tex}
    %
    % 7.3 The rational numbers
    %\input{src/ch7/s4.tex}
    \input{src/ch7/s4_minimal.tex}
    %
    % 7.3 The real numbers
    %\input{src/ch7/s5.tex}
    \input{src/ch7/s5_minimal.tex}
    %
    %
    ...
    %\input{src/ch10/s1.tex}
    \input{src/ch10/s1_minimal.tex}
    %
    % 10.2 Countable and uncountable
    \input{src/ch10/s2.tex}
    %
    % 10.3 Sums and products
    \input{src/ch10/s3.tex}
    %
    % 10.3 Powers and beyond.
    \input{src/ch10/s4.tex}
  \end{multicols}
\end{document}
